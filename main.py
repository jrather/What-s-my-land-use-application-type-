...
print("Welcome! Please answer the questions below to determine what type of planning application you will need to submit. For each question, please input numbers without commas.")
